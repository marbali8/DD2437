...
#     err_b = np.mean(np.abs(out_val_b - tar_val))
...
#
# plt.figure(2), plt.yscale('log'), plt.ylim([1e-4, 10]), plt.xlabel('nodes'), plt.ylabel('widths'), plt.title('delta rule')
# plt.figure(3), plt.yscale('log'), plt.ylim([1e-4, 10]), plt.xlabel('nodes'), plt.ylabel('widths'), plt.title('batch rule')
