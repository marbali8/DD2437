...
# 1. perceptron converges (if does) first, but line is worse. low lr need more epochs.
...
# plot_error(e_s[::2*n], 'sequential')
# plt.show()
# plt.close()

# 2. sequential converges first, very sensitive to random init! (comment seed(0))
