Comment by Mar: i put the data in data/, i changed the mp4 animations to gif and
added them to the subfolder receptive_fields, and asked a question if i wanted to
clear the trained models before loading!!
