...
class DeepBeliefNet():
    ...
    def generate(self,true_lbl,name):
        ...
        import matplotlib.animation as animation # ADDED BY ME for PillowWriter warning
        ...
        anim = stitch_video(fig,records).save("receptive_fields/%s.generate%d.gif"%(name,np.argmax(true_lbl)), animation.PillowWriter(fps=30))
